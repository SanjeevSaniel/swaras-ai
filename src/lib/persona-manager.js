// src/lib/persona-manager.js - Generic Persona Management System
...
export class PersonaManager {
   ...
   */
  loadPersonas(config) {
    Object.entries(config).forEach(([id, persona]) => {
  ...
  getPersonasByCategory(category) {
    ...
    return ids.map(id => this.personas.get(id)).filter(Boolean);
  }
