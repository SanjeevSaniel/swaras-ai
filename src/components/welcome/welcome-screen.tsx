...
const WelcomeScreen = ({ onQuickStart }: WelcomeScreenProps) => {
  ...
  const getConversationStarters = (personaId: string) => {
    const starters = {
      hitesh: [
      ...
      <motion.div
        ...
        <div className='max-w-2xl w-full text-center'>
          ...
          <motion.p
            ...
            Select a mentor from the sidebar to start your personalized learning
            journey
          </motion.p>
                  ...
                  .map(([id, p]: [string, any], index) => (
                    <motion.div
                      ...
                      <Image
                        ...
                        width={56}
                        height={56}
                        className='rounded-full border-4 border-background object-cover shadow-md hover:scale-110 transition-transform cursor-pointer'
                        onError={(e) => {
          ...
          <motion.div
            ...
            <p className='text-xs text-muted-foreground/60 max-w-md'>
              Click on any mentor card in the left sidebar to begin. Each mentor
              has unique expertise and communication style tailored to help you
              learn effectively.
            </p>
          </motion.div>
        </div>
  ...
  return (
    <motion.div
      ...
      className='h-full flex items-center justify-center px-6 pt-24 pb-12 overflow-y-auto'>
        ...
        {onQuickStart && (
          <div className='space-y-2 mb-6'>
            ...
            <div className='grid gap-2'>
              {getConversationStarters(selectedPersona).map(
                (starter, index) => (
                  <motion.button
                    key={index}
                    ...
                    onClick={() => {
                      if (mentorsOnline) {
                        window.dispatchEvent(
                          new CustomEvent('setInputValue', { detail: starter }),
                        );
                      }
                    }}
                    ...
                    <div className='flex items-center justify-between gap-2'>
                      <span className='text-foreground/90 font-medium line-clamp-1'>
                        {starter}
                      </span>
                      <svg
