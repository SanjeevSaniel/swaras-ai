...
const personas = {
  hitesh: {
    ...
    expertise: [
      ...
      "MongoDB", "Express.js", "Docker", "Full Stack Development",
      "Career Advice", "Web Development", "Programming Tutorials"
    ],
  ...
  piyush: {
    ...
    expertise: [
      "MERN Stack", "TypeScript", "Next.js", "System Design",
      "DevOps", "Docker", "AWS", "PostgreSQL", "MongoDB",
      "Backend Architecture", "Microservices", "Cloud Computing"
    ],
